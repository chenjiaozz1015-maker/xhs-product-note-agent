...
Render 当前如果 `/health` 返回 `font_file_exists=false`、`font_path=null`，请手动下载开源授权字体 `Noto Sans SC Regular`，并放到：
...
{
  "font_file_exists": true,
  "font_path": "/opt/render/project/src/app/static/fonts/NotoSansSC-Regular.otf"
}
```
